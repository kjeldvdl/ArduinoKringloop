...
void reconnect() {
  ...
  while (!MQTTclient.connected()) {
    sendStrXY("Attempting MQTT connection...", 0, 1); 
    ...
    if (MQTTclient.connect("ESP8266Client")) {
      ...
      sendStrXY("failed, rc=", 1, 1); 
      Serial.print(MQTTclient.state());
      //sendStrXY(Char(MQTTclient.state()), 2, 1); 
      Serial.println(" try again in 5 seconds");
      sendStrXY("try again in 5 seconds", 3, 1); 
